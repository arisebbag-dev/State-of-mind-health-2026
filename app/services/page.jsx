...
export const metadata = {
  title: "Services | State of Mind Health",
  description:
    "Expert medication management, telepsychiatry & genetic testing in Suffern, NY. Personalized psychiatric care for the tri-state area.",
